...
import Arduno from 'public/arduno.jpg'
import Kmitl from 'public/KMITL.jpg'
function Activity() {
  return (
    <div className='box '>
      <session id="activity">
        <div className="con  h-[1700px]">
            ...
            <div className="concon flex justify-center">
                <div className="img p-5 md:grid grid-cols-2 gap-10  w-[200vh]">
                    ...
                    <div className="ac2 ">
                        <Image src={Arduno} alt='good' className='w-full' />
                        <div className="textimg">
                    ...
                    <div className="ac3">
                        <Image src={Kmitl} alt='good' className='w-full' />
                        <div className="textimg">
